        ...
        <div className="container">
          <div className="row gy-3 gy-md-4 gy-lg-0 align-items-xl-center">
            <div className="col-12 ">
              <img className="img-fluid rounded" loading="lazy" src="../../assets/image/nielt.jpg"   style={{"height":"50vh", "display":"flex","justifyContent":"center","alignItems":"center"}} alt="Get in Touch" />
            </div>
            <div className="col-12 ">
